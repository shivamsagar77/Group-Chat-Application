...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    CONVERSATION_MEMBERS: '/api/conversation_members',
    GET_USERS_FOR_CHAT: '/api/users/get_user_for_chat',
...
export const API_URLS = {
  ...
  CONVERSATION_MEMBERS: `${API_CONFIG.BASE_URL}${API_CONFIG.ENDPOINTS.CONVERSATION_MEMBERS}`,
  GET_USERS_FOR_CHAT: `${API_CONFIG.BASE_URL}${API_CONFIG.ENDPOINTS.GET_USERS_FOR_CHAT}`,
  MESSAGES: `${API_CONFIG.BASE_URL}${API_CONFIG.ENDPOINTS.MESSAGES}`
};
